...
export default function GameDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased flex flex-col select-none relative">
      ...
      <div 
        className={`fixed top-0 left-0 right-0 h-24 bg-slate-950/95 backdrop-blur-md border-b border-slate-900/80 z-50 transition-all duration-300 transform grid items-center px-6 ${
          showStickyHeader ? "translate-y-0 opacity-100 shadow-2xl" : "-translate-y-full opacity-0 pointer-events-none"
        }`}
      >
        <div className="max-w-7xl w-full mx-auto flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 min-w-0">
            ...
            <img 
              ...
              alt="" 
              className="h-12 w-auto object-contain rounded-lg border border-slate-800/80 shadow-md"
            />
      ...
      <div className="relative h-[480px] md:h-[520px] w-full overflow-hidden border-b border-slate-900 bg-slate-950 shrink-0">
        ...
        <img 
          src={game.assets.thumbnailUrl} 
          alt="" 
          className="w-full h-full object-cover opacity-35 blur-[1.5px] scale-102 select-none pointer-events-none" 
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-end gap-10 w-full mt-auto">
            <div className="lg:col-span-5 flex items-center justify-start h-full max-h-[220px]">
              ...
              <img 
                src={game.assets.thumbnailUrl} 
                alt={`${game.title} Logo`} 
                className="max-h-[200px] w-auto object-contain rounded-xl shadow-2xl border border-slate-800/40 select-none pointer-events-none"
              />
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className={`px-3 py-1.5 text-[10px] font-black tracking-wider uppercase rounded-md border transition-all ${
                      activeTagId === null
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:justify-end shrink-0">
                      {ach.tags?.map((tag) => {
                        ...
                        return (
                          <span 
                            key={tag.id} 
                            className={`px-2 py-0.5 text-[9px] font-black tracking-wider uppercase rounded border select-none transition-all ${
                              isCurrentlyFiltered 
              ...
              <div className="bg-slate-900/20 border border-slate-900 p-5 rounded-xl space-y-5">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed italic">
                    Note: A future schema update will replace this area with dedicated, editable data fields covering specific route steps.
                  </p>
                </div>
