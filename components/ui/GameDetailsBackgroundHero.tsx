                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 items-center lg:items-end gap-3 lg:gap-10 w-full mt-auto">
                    ...
                    <div className="lg:col-span-5 flex items-center justify-start w-full lg:h-full lg:max-h-[220px]">
                        <img
                            ...
                            className="mx-auto lg:mx-0 h-24 sm:h-28 lg:h-auto lg:max-h-[200px] w-auto max-w-[85vw] lg:max-w-[500px] lg:w-full object-contain select-none pointer-events-none drop-shadow-[1px_1px_0px_rgba(255,255,255,0.4)] drop-shadow-[-1px_-1px_0px_rgba(255,255,255,0.4)]" 
                        />
                    </div>
